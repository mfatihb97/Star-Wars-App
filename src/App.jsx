...
function App() {
  ...
  const handleSearch = () => {
    if (searchTerm.trim() === '') {
      ...
      (starship.model && starship.model.toLowerCase().includes(searchTerm.toLowerCase()))
      );
  ...
  return (
    <div className='container'>
      <div className='header'>
        ...
        <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Star_Wars_Logo.svg/1200px-Star_Wars_Logo.svg.png' style={{height:'150px',width:'400px',marginBottom:'20px'}}/>
      ...
      <div className='load-more-container'>
        <button onClick={handleLoadMore} className='load-more-button'>Load More Ships</button>
      </div>
